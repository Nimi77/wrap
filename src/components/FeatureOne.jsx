...
function FeatureOne() {
  return (
    <Box className="w-full">
      <Box className="h-331 bg-light"></Box>
      <Box className="flex flex-col items-center justify-center gap-3 mx-auto -translate-y-64">
        <Heading className="text-4xl text-center text-primary font-bold w-571 lg:text-5xl">
          Get Your Life Back in Order with <span className="g-text">Wrap</span>
        </Heading>
        <Box className="f1-card-container font-Reddit max-w-80 grid grid-cols-1 gap-8 mx-auto sm:grid-cols-2 lg:grid-cols-3">
          {/* card-one */}
